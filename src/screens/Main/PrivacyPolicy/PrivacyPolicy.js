    ...
    <View>
      ...
      <View style={{paddingHorizontal: 15}}>
        <CustomHeader
          ...
          Center={() => <CustomText label="Privacy Policy" fontSize={16} />}
        />
      </View>
      <Spacer height={25} />
      <ScrollView>
        <View style={{paddingHorizontal:20}} >
            <CustomText label="Privacy" fontSize={15} />
            <CustomText alignSelf="center" color={colors.grey1}  label="Sed ut perspiciatis unde omnis iste natus error sit
...
nihil molestiae consequatur, vel illum qui dolorem eum" />
        ...
        <View style={{paddingHorizontal:20}} >
            <CustomText label="Policy" fontSize={15} />
            <CustomText alignSelf="center" color={colors.grey1}  label="Sed ut perspiciatis unde omnis iste natus error sit
voluptatem accusantium doloremque laudantium, totam
rem aperiam, eaque ipsa quae ab illo inventore veritatis et
quasi architecto beatae vitae dicta sunt explicabo. Nemo
